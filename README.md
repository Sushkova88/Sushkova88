# Привет, меня зовут Анна, я начинающий QA инженер, стремящийся к совершенству 🌟
...
<div>
  ...
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original.svg" title="mysql" alt="mysql" width="40" height="40"/>&nbsp" title="mysql" alt="mysql" width="40" height="40"/>&nbsp
...
- 📫 Связаться со мной можно по email: [email@example.com](mailto:petryaeva280488@gmail.com)
